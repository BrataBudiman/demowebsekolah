                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>021234567
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>info@websekolah.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>BSD, Tangerang, INA. 15142
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url('');?>" class="navbar-brand nav-brand2">WEBSEKOLAH
                        <!-- <img class="img img-responsive" width="200px;" src="<?php echo base_url().'theme/images/logo-dark.png'?>"> -->
                        </a>
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               <h2>Welcome</h2>
               <p>Kami Menyambut baik terbitnya Website sekolah yang baru , dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
                    ...
                    <p><?php echo date('Y');?> © copyright by Brata. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> BSD, Tangerang, INA. 15142</p>
                        <p>Email : info@websekolah.com
